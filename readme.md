...
*[x] Display news desk tag in the search result

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/aDkzFzd.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Generate JAVA class using http://www.jsonschema2pojo.org/

ISSUE:Execution failed for task ':app:clean'. Unable to delete file xxx
[Solution](http://stackoverflow.com/questions/32914499/error-execution-failed-for-task-appclean-unable-to-delete-file)
